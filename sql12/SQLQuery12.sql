select distinct top 30 xcl.cWhCode as 仓库编码,xcl.cInvCode as 存货编码, chda.cInvName as 存货名称,chda.cInvStd as 规格型号,xcl.cBatch as 批号,xcl.iQuantity as 可用数量, chda.cInvAddCode as 规格型号,cgrk.cBusType as 采购类型,cgrk.cOrderCode as 采购订单号, cgrk.dnverifytime as 入库时间,cgddz.iQuantity as 采购数量, cgdd.cVenCode as 采购供应商编码,gysda.cVenAbbName as 供应商简称, qg.cCode as 请购单号,zdy.cbdefine29 as 请购人,qg.cMaker as 请购单制单人, qg.cVerifier as 请购单审核人,qg.cAuditDate as 请购审核日期 
